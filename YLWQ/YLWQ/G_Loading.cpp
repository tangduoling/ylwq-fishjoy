...
{
      texload[0]=phge->Texture_Load("Loading\\0.png");
	  texload[1]=phge->Texture_Load("Loading\\1.png");
	  texload[2]=phge->Texture_Load("Loading\\2.png");
	  texload[3]=phge->Texture_Load("Loading\\3.png");
